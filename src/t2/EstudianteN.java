 ...
 * @author emers
 */
public class EstudianteN extends javax.swing.JFrame {

    /**
     * Creates new form EstudianteN
     */
    public EstudianteN() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstudianteN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstudianteN().setVisible(true);
            }
        });
    }
